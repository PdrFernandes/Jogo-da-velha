...
public class BDServer {
    ...
    public static void main(String[] args) {
    	...
    	try {
            ...
            System.out.println(sel_amizade_usuario(Integer.parseInt(
                    (sel_usuario_username_literal("Pdr").getFirst()).get("id_usuario").toString()), null));
     ...
     * - id_2: id do usuário (NÃO OBRIGATÓRIO)
     * (Caso dois parâmetros nulos, retorna todas amizades)
     * (Caso id_2 nulo, retorna todos usuários que id_1 é amigo, com username de cada amigo)
     * (Caso id_1 nulo, retorna todas pessoas que possuem como amigo id_2)
     * */
    public static List<Map<String, Object>> sel_amizade_usuario(Integer id_1, Integer id_2) throws SQLException {
        ResultSet rs = null;
        List<Map<String, Object>> resultList = new ArrayList<Map<String, Object>>();
        //Tenta estabelecer a conexão
        try (Connection con = DriverManager.getConnection(BDServer.connectionUrl);) {
